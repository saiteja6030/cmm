...
(4, 'kkdops', '900150983cd24fb0d6963f7d28e17f72', 4, 2, 3, 'krishna mohan', '9876543210', '', '', 1, 2, '2017-03-06 09:27:39', 2, '2017-03-16 15:38:27'),
(6, 'headoffice', '900150983cd24fb0d6963f7d28e17f72', 2, 1, 2, 'Venkatesh', '9876543210', '', '', 1, 2, '2017-03-06 09:28:45', NULL, NULL),
(7, 'stockpoint', '900150983cd24fb0d6963f7d28e17f72', 6, 3, 3, 'Ramesh', '9876543210', '', '', 1, 2, '2017-03-06 09:30:04', NULL, NULL);
...
(0, 2, '2020-09-03 11:36:33', '2020-09-03 11:36:33', '2020-09-03 11:37:23', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.83 Safari/537.36');
...
ALTER TABLE `approval_list`
  ...
  ADD KEY `rep_preference_id` (`rep_preference_id`,`issue_at`),
  ADD KEY `issue_at` (`issue_at`);

--
-- Indexes for table `approval_list_history`
--
ALTER TABLE `approval_list_history`
  ADD PRIMARY KEY (`approval_his_id`),
  ADD KEY `approval_id` (`approval_id`,`issued_by`),
...
ALTER TABLE `bank_guarantee`
  ...
  ADD KEY `FKbank_guara133597` (`bank_id`),
  ADD KEY `FKbank_guara637714` (`distributor_id`);
...
--
-- Indexes for table `block_designation`
--
ALTER TABLE `block_designation`
  ADD PRIMARY KEY (`block_designation_id`),
  ADD UNIQUE KEY `block_designation` (`block_id`,`designation_id`),
  ADD KEY `FKblock_desi387992` (`block_id`),
  ADD KEY `FKblock_desi69464` (`designation_id`);

--
-- Indexes for table `block_designation_page`
--
ALTER TABLE `block_designation_page`
  ADD PRIMARY KEY (`block_designation_id`,`page_id`),
  ADD KEY `FKblock_desi306399` (`block_designation_id`),
  ADD KEY `FKblock_desi588764` (`page_id`);

--
-- Indexes for table `block_designation_page_history`
--
ALTER TABLE `block_designation_page_history`
  ADD PRIMARY KEY (`bdph_id`);
...
ALTER TABLE `broker`
  ...
  ADD KEY `FKbroker67953` (`location_id`);

--
-- Indexes for table `broker_bank_guarantee`
--
ALTER TABLE `broker_bank_guarantee`
  ADD PRIMARY KEY (`broker_bg_id`),
  ADD KEY `broker_id` (`broker_id`,`bank_id`),
...
ALTER TABLE `capacity`
  ...
  ADD KEY `FKcapacity280467` (`unit_id`);

--
-- Indexes for table `capacity_micron`
--
ALTER TABLE `capacity_micron`
  ADD PRIMARY KEY (`capacity_id`,`micron_id`),
  ADD KEY `FKcapacity_m762714` (`capacity_id`),
  ADD KEY `FKcapacity_m353792` (`micron_id`);

--
-- Indexes for table `capacity_micron_history`
--
ALTER TABLE `capacity_micron_history`
  ADD PRIMARY KEY (`cmh_id`),
  ADD KEY `FKcapacity_m387443` (`capacity_id`,`micron_id`);

--
-- Indexes for table `counter_sale`
--
ALTER TABLE `counter_sale`
  ADD PRIMARY KEY (`counter_sale_id`),
  ADD KEY `FKcounter_sa315116` (`counter_id`),
  ADD KEY `FKcounter_sa673321` (`cs_category_id`),
  ADD KEY `FKcounter_sa587357` (`cs_pay_mode_id`),
  ADD KEY `FKcounter_sa393031` (`bank_id`);
...
--
-- Indexes for table `credit_debit_purpose`
--
ALTER TABLE `credit_debit_purpose`
...
--
-- Indexes for table `cs_pay_mode`
--
ALTER TABLE `cs_pay_mode`
  ADD PRIMARY KEY (`cs_pay_mode_id`);
...
ALTER TABLE `cs_product`
  ...
  ADD KEY `FKcs_product308883` (`counter_sale_id`),
  ADD KEY `FKcs_product494364` (`product_id`);

--
-- Indexes for table `c_and_f`
--
ALTER TABLE `c_and_f`
  ADD PRIMARY KEY (`c_and_f_id`),
  ADD KEY `FKc_and_f148107` (`plant_id`);

--
-- Indexes for table `c_and_f_agreement_history`
--
ALTER TABLE `c_and_f_agreement_history`
  ADD PRIMARY KEY (`cfah_id`),
  ADD KEY `FKc_and_f_ag459445` (`c_and_f_id`);

--
-- Indexes for table `c_and_f_bank_gurantee`
--
ALTER TABLE `c_and_f_bank_gurantee`
  ADD PRIMARY KEY (`bg_id`),
  ADD KEY `FKc_and_f_ba141917` (`bank_id`),
  ADD KEY `FKc_and_f_ba1531` (`c_and_f_id`);

--
-- Indexes for table `c_and_f_credit_debit_note`
--
ALTER TABLE `c_and_f_credit_debit_note`
  ADD PRIMARY KEY (`note_id`),
  ADD KEY `FKc_and_f_cr750801` (`purpose_id`),
  ADD KEY `FKc_and_f_cr439715` (`plant_id`);

--
-- Indexes for table `c_and_f_payment`
--
ALTER TABLE `c_and_f_payment`
  ADD PRIMARY KEY (`payment_id`),
  ADD KEY `FKc_and_f_pa451231` (`plant_id`),
  ADD KEY `FKc_and_f_pa544696` (`pay_mode_id`),
  ADD KEY `FKc_and_f_pa486960` (`bank_id`);

--
-- Indexes for table `daily_corrections`
--
ALTER TABLE `daily_corrections`
  ADD PRIMARY KEY (`correction_id`);

--
-- Indexes for table `data_receipt_product`
--
ALTER TABLE `data_receipt_product`
  ADD PRIMARY KEY (`auto_inc_id`);

--
-- Indexes for table `deleted_invoice_details`
--
ALTER TABLE `deleted_invoice_details`
  ADD PRIMARY KEY (`delete_invoice_id`);
...
--
-- Indexes for table `designation_reporting`
--
ALTER TABLE `designation_reporting`
  ADD PRIMARY KEY (`reportee_id`,`reporting_id`),
  ADD KEY `FKdesignatio284410` (`reportee_id`),
  ADD KEY `FKdesignatio536616` (`reporting_id`);
...
ALTER TABLE `distributor`
  ...
  ADD KEY `FKdistributo837770` (`type_id`),
  ADD KEY `FKdistributo198227` (`location_id`),
  ADD KEY `FKdistributo601100` (`agent_id`),
  ADD KEY `FKdistributo817443` (`user_id`);

--
-- Indexes for table `distributor_agreement_history`
--
ALTER TABLE `distributor_agreement_history`
  ADD PRIMARY KEY (`dah_id`),
  ADD KEY `FKdistributo735256` (`distributor_id`);

--
-- Indexes for table `distributor_credit_debit_note`
--
ALTER TABLE `distributor_credit_debit_note`
  ADD PRIMARY KEY (`note_id`),
  ADD KEY `FKdistributo172194` (`purpose_id`),
  ADD KEY `FKdistributo392719` (`distributor_id`);

--
-- Indexes for table `distributor_order`
--
ALTER TABLE `distributor_order`
  ADD PRIMARY KEY (`distributor_id`,`order_id`),
  ADD KEY `FKdistributo285266` (`distributor_id`),
  ADD KEY `FKdistributo468515` (`order_id`);

--
-- Indexes for table `distributor_payment`
--
ALTER TABLE `distributor_payment`
  ADD PRIMARY KEY (`payment_id`),
  ADD KEY `FKdistributo683126` (`pay_mode_id`),
  ADD KEY `FKdistributo127178` (`distributor_id`),
  ADD KEY `FKdistributo623060` (`bank_id`);

--
-- Indexes for table `distributor_price_type`
--
ALTER TABLE `distributor_price_type`
  ADD PRIMARY KEY (`price_type_id`);

--
-- Indexes for table `distributor_trans`
--
ALTER TABLE `distributor_trans`
  ADD PRIMARY KEY (`dist_trans_id`),
  ADD KEY `distributor_id` (`distributor_id`,`trans_type_id`);

--
-- Indexes for table `distributor_trans_type`
--
ALTER TABLE `distributor_trans_type`
  ADD PRIMARY KEY (`dist_trans_type_id`);

--
-- Indexes for table `distributor_type`
--
ALTER TABLE `distributor_type`
  ADD PRIMARY KEY (`type_id`);

--
-- Indexes for table `dist_ob_penalty`
--
ALTER TABLE `dist_ob_penalty`
  ADD PRIMARY KEY (`ob_penality_id`);

--
-- Indexes for table `dist_sd_amount_history`
--
ALTER TABLE `dist_sd_amount_history`
  ADD PRIMARY KEY (`sd_amount_h_id`);
...
ALTER TABLE `do`
  ...
  ADD KEY `fk_liftingpoint_26032017_idx` (`lifting_point`);

--
-- Indexes for table `do_against`
--
ALTER TABLE `do_against`
  ADD PRIMARY KEY (`do_against_id`);

--
-- Indexes for table `do_order`
--
ALTER TABLE `do_order`
  ADD PRIMARY KEY (`do_ob_id`),
  ADD KEY `FKdo_order541202` (`order_id`),
  ADD KEY `FKdo_order322088` (`do_id`);

--
-- Indexes for table `do_order_product`
--
ALTER TABLE `do_order_product`
  ADD PRIMARY KEY (`do_ob_product_id`),
  ADD KEY `FKdo_order_p191106` (`do_ob_id`),
  ADD KEY `FKdo_order_p705907` (`product_id`);
...
ALTER TABLE `executive`
  ...
  ADD KEY `FKexecutive709729` (`location_id`),
  ADD KEY `FKexecutive642644` (`user_id`);

--
-- Indexes for table `executive_limit`
--
ALTER TABLE `executive_limit`
  ADD PRIMARY KEY (`executive_limit_id`);

--
-- Indexes for table `ffa_rebate`
--
ALTER TABLE `ffa_rebate`
  ADD PRIMARY KEY (`ffa_rebate_id`);

--
-- Indexes for table `fgs_free_gift`
--
ALTER TABLE `fgs_free_gift`
  ADD PRIMARY KEY (`gift_product_id`),
  ADD KEY `FKfgs_free_g438108` (`free_gift_id`),
  ADD KEY `FKfgs_free_g226357` (`fgs_product_id`);

--
-- Indexes for table `fgs_free_product`
--
ALTER TABLE `fgs_free_product`
  ADD PRIMARY KEY (`free_product_id`),
  ADD KEY `FKfgs_free_p836441` (`fgs_product_id`),
  ADD KEY `FKfgs_free_p491081` (`product_id`),
  ADD KEY `FKfgs_free_p647906` (`item_type_id`);

--
-- Indexes for table `fg_scheme_product`
--
ALTER TABLE `fg_scheme_product`
  ADD PRIMARY KEY (`fgs_product_id`),
  ADD KEY `FKfg_scheme_213635` (`item_type_id`),
  ADD KEY `FKfg_scheme_675004` (`gift_type_id`),
  ADD KEY `FKfg_scheme_489206` (`fg_scheme_id`),
  ADD KEY `FKfg_scheme_914780` (`product_id`);
...
--
-- Indexes for table `free_gift_scheme`
--
ALTER TABLE `free_gift_scheme`
  ADD PRIMARY KEY (`fg_scheme_id`),
  ADD KEY `FKfree_gift_191330` (`type_id`);

--
-- Indexes for table `free_sample`
--
ALTER TABLE `free_sample`
  ADD PRIMARY KEY (`free_sample_id`),
  ADD KEY `FKfree_sampl572219` (`plant_id`),
  ADD KEY `FKfree_sampl866568` (`product_id`);
...
ALTER TABLE `gatepass`
  ...
  ADD KEY `FKgatepass8037` (`tanker_id`);

--
-- Indexes for table `gatepass_history`
--
ALTER TABLE `gatepass_history`
  ADD PRIMARY KEY (`gatepass_history_id`),
  ADD KEY `gatepass_id` (`gatepass_id`),
  ADD KEY `tanker_id` (`tanker_id`);

--
-- Indexes for table `gatepass_invoice`
--
ALTER TABLE `gatepass_invoice`
  ADD PRIMARY KEY (`gatepass_invoice_id`),
  ADD KEY `FKgatepass_i824637` (`gatepass_id`),
  ADD KEY `FKgatepass_i824064` (`invoice_id`);
...
--
-- Indexes for table `godown_stock_transfer`
--
ALTER TABLE `godown_stock_transfer`
  ADD PRIMARY KEY (`gst_id`),
  ADD KEY `FKgodown_sto348621` (`counter_id`),
  ADD KEY `FKgodown_sto380501` (`st_type_id`);

--
-- Indexes for table `gst_product`
--
ALTER TABLE `gst_product`
  ADD PRIMARY KEY (`gst_product_id`),
  ADD KEY `FKgst_produc518881` (`gst_id`),
  ADD KEY `FKgst_produc393809` (`product_id`);
...
--
-- Indexes for table `insurance_product`
--
...
ALTER TABLE `invoice`
  ...
  ADD KEY `FKinvoice555166` (`invoice_type_id`),
  ADD KEY `FKplantid26032017_idx` (`plant_id`);

--
-- Indexes for table `invoice_do`
--
ALTER TABLE `invoice_do`
  ADD PRIMARY KEY (`invoice_do_id`),
  ADD KEY `FKinvoice_do138010` (`invoice_id`),
  ADD KEY `FKinvoice_do378493` (`do_id`),
  ADD KEY `FKinvoice_do515202` (`order_id`);

--
-- Indexes for table `invoice_do_product`
--
ALTER TABLE `invoice_do_product`
  ADD PRIMARY KEY (`invoice_do_product_id`),
  ADD KEY `FKinvoice_do774797` (`invoice_do_id`),
  ADD KEY `FKinvoice_do287150` (`product_id`);

--
-- Indexes for table `invoice_free_gift`
--
ALTER TABLE `invoice_free_gift`
  ADD PRIMARY KEY (`invoice_fg_id`),
  ADD KEY `FKinvoice_fr152399` (`free_gift_id`),
  ADD KEY `FKinvoice_fr870934` (`invoice_scheme_id`);

--
-- Indexes for table `invoice_free_product`
--
ALTER TABLE `invoice_free_product`
  ADD PRIMARY KEY (`invoice_free_product_id`),
  ADD KEY `FKinvoice_fr105786` (`product_id`),
  ADD KEY `FKinvoice_fr262611` (`item_type_id`),
  ADD KEY `FKinvoice_fr275807` (`invoice_scheme_id`);

--
-- Indexes for table `invoice_pm`
--
ALTER TABLE `invoice_pm`
  ADD PRIMARY KEY (`invoice_pm_id`),
  ADD KEY `FKinvoice_pm137640` (`invoice_id`),
  ADD KEY `FKinvoice_pm52213` (`pm_id`);

--
-- Indexes for table `invoice_scheme`
--
ALTER TABLE `invoice_scheme`
  ADD PRIMARY KEY (`invoice_scheme_id`),
  ADD KEY `FKinvoice_sc638053` (`invoice_id`),
  ADD KEY `FKinvoice_sc631445` (`fg_scheme_id`);
...
--
-- Indexes for table `leakage_entry`
--
ALTER TABLE `leakage_entry`
  ADD PRIMARY KEY (`leakage_id`),
  ADD KEY `FKleakage_en721513` (`plant_id`);

--
-- Indexes for table `leakage_pm`
--
ALTER TABLE `leakage_pm`
  ADD PRIMARY KEY (`lpm_id`),
  ADD KEY `FKproduction496791` (`ops_leakage_id`),
  ADD KEY `FKproduction668870` (`pm_id`);

--
-- Indexes for table `leakage_pm_micron`
--
ALTER TABLE `leakage_pm_micron`
  ADD PRIMARY KEY (`leakage_pm_id`),
  ADD KEY `FKproduction496791` (`ops_leakage_id`),
  ADD KEY `FKproduction668870` (`pm_id`),
  ADD KEY `FKproduction526121` (`micron_id`);

--
-- Indexes for table `leakage_product`
--
ALTER TABLE `leakage_product`
  ADD PRIMARY KEY (`leakage_product_id`),
  ADD KEY `FKleakage_pr626894` (`leakage_id`),
  ADD KEY `FKleakage_pr60916` (`product_id`);

--
-- Indexes for table `leakage_recovered_oil`
--
ALTER TABLE `leakage_recovered_oil`
  ADD PRIMARY KEY (`oil_recovery_id`),
  ADD KEY `FKleakage_re720245` (`loose_oil_id`),
  ADD KEY `FKleakage_re228888` (`recovery_id`);

--
-- Indexes for table `leakage_recovered_products`
--
ALTER TABLE `leakage_recovered_products`
  ADD PRIMARY KEY (`recovery_product_id`),
  ADD KEY `FKleakage_re927139` (`product_id`),
  ADD KEY `FKleakage_re30166` (`recovery_id`);

--
-- Indexes for table `leakage_recovery`
--
ALTER TABLE `leakage_recovery`
  ADD PRIMARY KEY (`recovery_id`),
  ADD KEY `FKleakage_re892674` (`leakage_id`);

--
-- Indexes for table `lit_product`
--
ALTER TABLE `lit_product`
  ADD PRIMARY KEY (`lit_product_id`);
...
ALTER TABLE `location`
  ...
  ADD KEY `FKlocation769072` (`parent_id`),
  ADD KEY `FKlocation79020` (`level_id`);
...
--
-- Indexes for table `loose_oil`
--
ALTER TABLE `loose_oil`
  ADD PRIMARY KEY (`loose_oil_id`);

--
-- Indexes for table `loose_oil_test`
--
ALTER TABLE `loose_oil_test`
  ADD PRIMARY KEY (`test_id`),
  ADD KEY `FKloose_oil_62291` (`loose_oil_id`),
  ADD KEY `FKloose_oil_889502` (`test_unit_id`),
  ADD KEY `FKloose_oil_98551` (`test_group_id`),
  ADD KEY `FKloose_oil_556219` (`range_type_id`);

--
-- Indexes for table `loss_in_transit`
--
ALTER TABLE `loss_in_transit`
  ADD PRIMARY KEY (`lit_id`);

--
-- Indexes for table `micron`
--
ALTER TABLE `micron`
  ADD PRIMARY KEY (`micron_id`);

--
-- Indexes for table `mrr_fg`
--
ALTER TABLE `mrr_fg`
  ADD PRIMARY KEY (`mrr_fg_id`),
  ADD KEY `FKmrr_fg33182` (`tanker_fg_id`);

--
-- Indexes for table `mrr_oil`
--
ALTER TABLE `mrr_oil`
  ADD PRIMARY KEY (`mrr_oil_id`),
  ADD KEY `FKmrr_oil622127` (`tanker_oil_id`),
  ADD KEY `FKmrr_oil890679` (`oil_tank_id`);

--
-- Indexes for table `mrr_oil_history`
--
ALTER TABLE `mrr_oil_history`
  ADD PRIMARY KEY (`mrr_oil_history_id`);

--
-- Indexes for table `mrr_pm`
--
ALTER TABLE `mrr_pm`
  ADD PRIMARY KEY (`mrr_pm_id`),
  ADD KEY `FKmrr_pm204619` (`tanker_pm_id`);

--
-- Indexes for table `mrr_pm_film`
--
ALTER TABLE `mrr_pm_film`
  ADD PRIMARY KEY (`mrr_pm_film_id`),
  ADD KEY `FKmrr_pm_fil777484` (`mrr_pm_id`),
  ADD KEY `FKmrr_pm_fil451363` (`micron_id`);

--
-- Indexes for table `mrr_pm_history`
--
ALTER TABLE `mrr_pm_history`
  ADD PRIMARY KEY (`mrr_pm_history_id`);

--
-- Indexes for table `mtp_oil`
--
ALTER TABLE `mtp_oil`
  ADD PRIMARY KEY (`mtp_oil_id`),
  ADD KEY `FKmtp_oil577711` (`loose_oil_id`),
  ADD KEY `FKmtp_oil880232` (`plant_id`);

--
-- Indexes for table `mtp_pm`
--
ALTER TABLE `mtp_pm`
  ADD PRIMARY KEY (`mtp_pm_id`),
  ADD KEY `FKmtp_pm220022` (`pm_id`),
  ADD KEY `FKmtp_pm961612` (`plant_id`);

--
-- Indexes for table `ob_penalty`
--
ALTER TABLE `ob_penalty`
  ADD PRIMARY KEY (`ob_penalty_id`);

--
-- Indexes for table `ob_status_history`
--
ALTER TABLE `ob_status_history`
  ADD PRIMARY KEY (`ob_status_id`);

--
-- Indexes for table `ob_type`
--
ALTER TABLE `ob_type`
  ADD PRIMARY KEY (`ob_type_id`);

--
-- Indexes for table `oil_ob_status_history`
--
ALTER TABLE `oil_ob_status_history`
  ADD PRIMARY KEY (`oil_ob_status_id`);

--
-- Indexes for table `oil_stock_balance`
--
ALTER TABLE `oil_stock_balance`
  ADD PRIMARY KEY (`oil_stock_balance_id`),
  ADD KEY `FKoil_stock_936951` (`loose_oil_id`),
  ADD KEY `FKoil_stock_239473` (`plant_id`);

--
-- Indexes for table `oil_tank`
--
ALTER TABLE `oil_tank`
  ADD PRIMARY KEY (`oil_tank_id`),
  ADD KEY `FKoil_tank131595` (`plant_id`),
  ADD KEY `FKoil_tank829073` (`loose_oil_id`);

--
-- Indexes for table `oil_tank_history`
--
ALTER TABLE `oil_tank_history`
  ADD PRIMARY KEY (`oth_id`),
  ADD KEY `FKoil_tank_h783299` (`oil_tank_id`);

--
-- Indexes for table `ops_leakage`
--
ALTER TABLE `ops_leakage`
  ADD PRIMARY KEY (`ops_leakage_id`),
  ADD KEY `FKops_leakag9160` (`plant_id`),
  ADD KEY `FKops_leakag714810` (`product_id`);

--
-- Indexes for table `ops_processing_loss`
--
ALTER TABLE `ops_processing_loss`
  ADD PRIMARY KEY (`processing_loss_id`),
  ADD KEY `plant_id_idx` (`plant_id`),
  ADD KEY `loose_oil_id_idx` (`loose_oil_id`);
...
ALTER TABLE `order`
  ...
  ADD KEY `FKorder182808` (`lifting_point`),
  ADD KEY `FKorder147515` (`ob_type_id`),
  ADD KEY `FKorder599060` (`welfare_scheme_id`);
...
ALTER TABLE `order_product`
  ...
  ADD KEY `FKorder_prod51337` (`order_id`),
  ADD KEY `FKorder_prod992432` (`product_id`);
...
ALTER TABLE `packing_material`
  ...
  ADD KEY `FKpacking_ma555347` (`pm_category_id`);

--
-- Indexes for table `packing_material_capacity`
--
ALTER TABLE `packing_material_capacity`
  ADD PRIMARY KEY (`pm_id`,`capacity_id`),
  ADD KEY `FKpacking_ma486598` (`pm_id`),
  ADD KEY `FKpacking_ma408113` (`capacity_id`);

--
-- Indexes for table `packing_material_category`
--
ALTER TABLE `packing_material_category`
  ADD PRIMARY KEY (`pm_category_id`),
  ADD KEY `FKpacking_ma821794` (`packing_type_id`),
  ADD KEY `FKpacking_ma918896` (`pm_unit`);

--
-- Indexes for table `packing_material_test`
--
ALTER TABLE `packing_material_test`
  ADD PRIMARY KEY (`pm_test_id`),
  ADD KEY `FKpacking_ma731915` (`range_type_id`),
  ADD KEY `FKpacking_ma886969` (`pm_category_id`),
  ADD KEY `FKpacking_ma65199` (`test_unit_id`);

--
-- Indexes for table `packing_type`
--
ALTER TABLE `packing_type`
  ADD PRIMARY KEY (`packing_type_id`);
...
ALTER TABLE `plant`
  ...
  ADD KEY `FKplant537396` (`location_id`);

--
-- Indexes for table `plant_block`
--
ALTER TABLE `plant_block`
  ADD PRIMARY KEY (`plant_id`,`block_id`),
  ADD KEY `FKplant_bloc812490` (`plant_id`),
  ADD KEY `FKplant_bloc955527` (`block_id`);

--
-- Indexes for table `plant_counter`
--
ALTER TABLE `plant_counter`
  ADD PRIMARY KEY (`counter_id`),
  ADD KEY `FKplant_coun968874` (`plant_id`);

--
-- Indexes for table `plant_counter_product`
--
ALTER TABLE `plant_counter_product`
  ADD PRIMARY KEY (`product_id`,`counter_id`),
  ADD KEY `FKplant_coun933280` (`product_id`),
  ADD KEY `FKplant_coun681117` (`counter_id`);

--
-- Indexes for table `plant_film_stock`
--
ALTER TABLE `plant_film_stock`
  ADD PRIMARY KEY (`plant_film_stock_id`),
  ADD KEY `FKplant_film760857` (`micron_id`),
  ADD KEY `FKplant_film774214` (`plant_id`),
  ADD KEY `FKplant_film15741` (`pm_id`);

--
-- Indexes for table `plant_free_gift`
--
ALTER TABLE `plant_free_gift`
  ADD PRIMARY KEY (`plant_id`,`free_gift_id`),
  ADD KEY `FKplant_free391195` (`plant_id`),
  ADD KEY `FKplant_free566211` (`free_gift_id`);

--
-- Indexes for table `plant_location`
--
ALTER TABLE `plant_location`
  ADD PRIMARY KEY (`plant_id`,`location_id`),
  ADD KEY `FKplant_loca893311` (`plant_id`),
  ADD KEY `FKplant_loca737901` (`location_id`);

--
-- Indexes for table `plant_order`
--
ALTER TABLE `plant_order`
  ADD PRIMARY KEY (`plant_id`,`order_id`),
  ADD KEY `FKplant_orde638461` (`plant_id`),
  ADD KEY `FKplant_orde110959` (`order_id`);

--
-- Indexes for table `plant_pm`
--
ALTER TABLE `plant_pm`
  ADD PRIMARY KEY (`plant_id`,`pm_id`),
  ADD KEY `FKplant_pm415782` (`plant_id`),
  ADD KEY `FKplant_pm374173` (`pm_id`);

--
-- Indexes for table `plant_product`
--
ALTER TABLE `plant_product`
  ADD PRIMARY KEY (`plant_id`,`product_id`),
  ADD KEY `FKplant_prod274859` (`plant_id`),
  ADD KEY `FKplant_prod402382` (`product_id`);

--
-- Indexes for table `plant_production`
--
ALTER TABLE `plant_production`
  ADD PRIMARY KEY (`plant_production_id`),
  ADD KEY `FKplant_prod627543` (`plant_id`);

--
-- Indexes for table `plant_recovery_oil`
--
ALTER TABLE `plant_recovery_oil`
  ADD PRIMARY KEY (`plant_id`,`loose_oil_id`),
  ADD KEY `FKplant_reco777474` (`plant_id`),
  ADD KEY `FKplant_reco474953` (`loose_oil_id`);

--
-- Indexes for table `pm_group`
--
ALTER TABLE `pm_group`
  ADD PRIMARY KEY (`pm_group_id`);

--
-- Indexes for table `pm_stock_balance`
--
ALTER TABLE `pm_stock_balance`
  ADD PRIMARY KEY (`pm_stock_balance_id`),
  ADD KEY `FKpm_stock_b470923` (`plant_id`),
  ADD KEY `FKpm_stock_b710711` (`pm_id`);

--
-- Indexes for table `pm_test_option`
--
ALTER TABLE `pm_test_option`
  ADD PRIMARY KEY (`option_id`),
  ADD KEY `FKpm_test_op159222` (`pm_test_id`);

--
-- Indexes for table `pm_unit`
--
ALTER TABLE `pm_unit`
  ADD PRIMARY KEY (`pm_unit`);

--
-- Indexes for table `po_fg_history`
--
ALTER TABLE `po_fg_history`
  ADD PRIMARY KEY (`po_fg_history_id`);

--
-- Indexes for table `po_fg_tanker`
--
ALTER TABLE `po_fg_tanker`
  ADD KEY `FKpo_fg_tank455211` (`po_fg_id`),
  ADD KEY `FKpo_fg_tank806627` (`tanker_id`);

--
-- Indexes for table `po_free_gift`
--
ALTER TABLE `po_free_gift`
  ADD PRIMARY KEY (`po_fg_id`),
  ADD KEY `FKpo_free_gi611312` (`free_gift_id`),
  ADD KEY `FKpo_free_gi731971` (`supplier_id`);

--
-- Indexes for table `po_oil`
--
ALTER TABLE `po_oil`
  ADD PRIMARY KEY (`po_oil_id`),
  ADD KEY `FKpo_oil710551` (`supplier_id`),
  ADD KEY `FKpo_oil134190` (`broker_id`),
  ADD KEY `FKpo_oil813722` (`mtp_oil_id`),
  ADD KEY `FKpo_oil725358` (`po_type_id`),
  ADD KEY `FKpo_oil182973` (`plant_id`),
  ADD KEY `FKpo_oil485494` (`loose_oil_id`);

--
-- Indexes for table `po_oil_history`
--
ALTER TABLE `po_oil_history`
  ADD PRIMARY KEY (`po_oil_history_id`);

--
-- Indexes for table `po_oil_lab_test`
--
ALTER TABLE `po_oil_lab_test`
  ADD PRIMARY KEY (`lab_test_id`),
  ADD KEY `FKpo_oil_lab390621` (`tanker_id`);

--
-- Indexes for table `po_oil_lab_test_results`
--
ALTER TABLE `po_oil_lab_test_results`
  ADD PRIMARY KEY (`test_result_id`),
  ADD KEY `FKpo_oil_lab739106` (`test_id`),
  ADD KEY `FKpo_oil_lab806726` (`lab_test_id`);

--
-- Indexes for table `po_oil_tanker`
--
ALTER TABLE `po_oil_tanker`
  ADD PRIMARY KEY (`po_oil_id`,`tanker_id`),
  ADD UNIQUE KEY `tanker_id` (`tanker_id`),
  ADD KEY `FKpo_oil_tan468229` (`po_oil_id`),
  ADD KEY `FKpo_oil_tan248574` (`tanker_id`);

--
-- Indexes for table `po_pm`
--
ALTER TABLE `po_pm`
  ADD PRIMARY KEY (`po_pm_id`),
  ADD KEY `FKpo_pm836865` (`po_type_id`),
  ADD KEY `FKpo_pm519186` (`mtp_pm_id`),
  ADD KEY `FKpo_pm887154` (`pm_id`),
  ADD KEY `FKpo_pm599044` (`supplier_id`),
  ADD KEY `FKpo_pm754302` (`broker_id`),
  ADD KEY `FKpo_pm294480` (`plant_id`);

--
-- Indexes for table `po_pm_history`
--
ALTER TABLE `po_pm_history`
  ADD PRIMARY KEY (`po_pm_history_id`);

--
-- Indexes for table `po_pm_lab_test`
--
ALTER TABLE `po_pm_lab_test`
  ADD PRIMARY KEY (`lab_test_id`),
  ADD KEY `FKpo_pm_lab_645870` (`tanker_id`),
  ADD KEY `FKpo_pm_lab_759824` (`pm_id`);

--
-- Indexes for table `po_pm_lab_test_results`
--
ALTER TABLE `po_pm_lab_test_results`
  ADD PRIMARY KEY (`test_result_id`),
  ADD KEY `FKpo_pm_lab_850406` (`lab_test_id`),
  ADD KEY `FKpo_pm_lab_312941` (`pm_test_id`);

--
-- Indexes for table `po_pm_tanker`
--
ALTER TABLE `po_pm_tanker`
  ADD KEY `FKpo_pm_tank912018` (`tanker_id`),
  ADD KEY `FKpo_pm_tank895511` (`po_pm_id`),
  ADD KEY `FKpo_pm_tank536346` (`tanker_pm_id`);

--
-- Indexes for table `po_type`
--
ALTER TABLE `po_type`
...
--
-- Indexes for table `preference_history`
--
ALTER TABLE `preference_history`
  ADD PRIMARY KEY (`preference_history_id`),
  ADD KEY `FKpreference855935` (`preference_id`);
...
ALTER TABLE `product`
  ...
  ADD KEY `FKproduct907511` (`loose_oil_id`),
  ADD KEY `fk5285packtype_idx` (`product_packing_type_id`);

--
-- Indexes for table `production_pm`
--
ALTER TABLE `production_pm`
  ADD PRIMARY KEY (`ppm_id`),
  ADD KEY `FKproduction496791` (`production_product_id`),
  ADD KEY `FKproduction668870` (`pm_id`);

--
-- Indexes for table `production_pm_micron`
--
ALTER TABLE `production_pm_micron`
  ADD PRIMARY KEY (`production_pm_id`),
  ADD KEY `FKproduction496791` (`production_product_id`),
  ADD KEY `FKproduction668870` (`pm_id`),
  ADD KEY `FKproduction526121` (`micron_id`);
...
ALTER TABLE `production_product`
  ADD PRIMARY KEY (`production_product_id`),
  ADD KEY `FKproduction210756` (`plant_production_id`),
  ADD KEY `FKproduction745891` (`product_id`);

--
-- Indexes for table `product_capacity`
--
ALTER TABLE `product_capacity`
  ADD PRIMARY KEY (`product_id`,`capacity_id`),
  ADD KEY `FKproduct_ca758285` (`product_id`),
  ADD KEY `FKproduct_ca815805` (`capacity_id`);

--
-- Indexes for table `product_packing_material`
--
ALTER TABLE `product_packing_material`
  ADD PRIMARY KEY (`product_id`,`capacity_id`,`pm_id`),
  ADD KEY `FKproduct_pa766298` (`product_id`,`capacity_id`);

--
-- Indexes for table `product_packing_type`
--
ALTER TABLE `product_packing_type`
  ADD PRIMARY KEY (`product_packing_type_id`);

--
-- Indexes for table `product_pm_weight`
--
ALTER TABLE `product_pm_weight`
  ADD PRIMARY KEY (`product_pm_weight_id`),
  ADD KEY `FKproduct_pm565392` (`product_id`);
...
ALTER TABLE `product_price`
  ...
  ADD KEY `FKproduct_pr792026` (`product_id`),
  ADD KEY `FKproduct_pr86376` (`plant_id`),
  ADD KEY `FKproduct_pr42160` (`price_type_id`);

--
-- Indexes for table `range_type`
--
ALTER TABLE `range_type`
  ADD PRIMARY KEY (`range_type_id`);

--
-- Indexes for table `rb_do`
--
ALTER TABLE `rb_do`
  ADD PRIMARY KEY (`do_hist_id`);

--
-- Indexes for table `rb_production`
--
ALTER TABLE `rb_production`
  ADD PRIMARY KEY (`rb_production_id`),
  ADD KEY `approval_id` (`approval_id`);

--
-- Indexes for table `receipt_free_gift`
--
ALTER TABLE `receipt_free_gift`
  ADD PRIMARY KEY (`rf_gift_id`),
  ADD KEY `FKreceipt_fr330967` (`receipt_invoice_id`),
  ADD KEY `FKreceipt_fr89946` (`free_gift_id`),
  ADD KEY `FKreceipt_fr793012` (`fg_scheme_id`);

--
-- Indexes for table `receipt_free_product`
--
ALTER TABLE `receipt_free_product`
  ADD PRIMARY KEY (`rf_product_id`),
  ADD KEY `FKreceipt_fr914099` (`receipt_invoice_id`),
  ADD KEY `FKreceipt_fr169871` (`product_id`),
  ADD KEY `FKreceipt_fr595445` (`fg_scheme_id`);

--
-- Indexes for table `receipt_invoice`
--
ALTER TABLE `receipt_invoice`
  ADD PRIMARY KEY (`receipt_invoice_id`),
  ADD KEY `FKreceipt_in998033` (`stock_receipt_id`),
  ADD KEY `FKreceipt_in148506` (`invoice_id`);

--
-- Indexes for table `receipt_invoice_product`
--
ALTER TABLE `receipt_invoice_product`
  ADD PRIMARY KEY (`receipt_invoice_product_id`),
  ADD KEY `FKreceipt_in475984` (`receipt_invoice_id`),
  ADD KEY `FKreceipt_in607986` (`product_id`);

--
-- Indexes for table `recovered_oil_production`
--
ALTER TABLE `recovered_oil_production`
  ADD PRIMARY KEY (`ro_production_id`),
  ADD KEY `FKrecovered_304918` (`loose_oil_id`);

--
-- Indexes for table `recovered_oil_scrap`
--
ALTER TABLE `recovered_oil_scrap`
  ADD PRIMARY KEY (`oil_scrap_id`),
  ADD KEY `FKrecovered_79883` (`loose_oil_id`),
  ADD KEY `FKrecovered_382404` (`plant_id`);

--
-- Indexes for table `reporting_preference`
--
ALTER TABLE `reporting_preference`
  ADD PRIMARY KEY (`rep_preference_id`),
  ADD KEY `FKreporting_109131` (`issue_raised_by`),
  ADD KEY `FKreporting_963898` (`issue_closed_by`);

--
-- Indexes for table `rop_product`
--
ALTER TABLE `rop_product`
  ADD PRIMARY KEY (`rop_product_id`),
  ADD KEY `FKrop_produc325112` (`ro_production_id`),
  ADD KEY `FKrop_produc703754` (`product_id`);
...
--
-- Indexes for table `stock_receipt`
--
ALTER TABLE `stock_receipt`
  ADD PRIMARY KEY (`stock_receipt_id`),
  ADD KEY `FKstock_rece603535` (`vehicle_number`),
  ADD KEY `FKstock_rece300374` (`plant_id`);

--
-- Indexes for table `stock_transfer_type`
--
ALTER TABLE `stock_transfer_type`
  ADD PRIMARY KEY (`st_type_id`);

--
-- Indexes for table `stock_updation`
--
ALTER TABLE `stock_updation`
  ADD PRIMARY KEY (`stock_updation_id`);
...
ALTER TABLE `supplier`
  ...
  ADD KEY `FKsupplier378633` (`location_id`),
  ADD KEY `FKsupplier553963` (`type_id`);

--
-- Indexes for table `supplier_bank_guarantee`
--
ALTER TABLE `supplier_bank_guarantee`
  ADD PRIMARY KEY (`supplier_bg_id`),
  ADD KEY `supplier_id` (`supplier_id`,`bank_id`),
  ADD KEY `bank_id` (`bank_id`);
...
--
-- Indexes for table `tanker_fg`
--
ALTER TABLE `tanker_fg`
  ADD PRIMARY KEY (`tanker_fg_id`),
  ADD KEY `FKtanker_fg770173` (`tanker_id`),
  ADD KEY `FKtanker_fg254914` (`free_gift_id`);

--
-- Indexes for table `tanker_oil`
--
ALTER TABLE `tanker_oil`
  ADD PRIMARY KEY (`tanker_oil_id`),
  ADD KEY `FKtanker_oil402055` (`loose_oil_id`),
  ADD KEY `FKtanker_oil199333` (`tanker_id`);

--
-- Indexes for table `tanker_pm`
--
ALTER TABLE `tanker_pm`
  ADD PRIMARY KEY (`tanker_pm_id`),
  ADD KEY `FKtanker_pm770489` (`tanker_id`),
  ADD KEY `FKtanker_pm884443` (`pm_id`);

--
-- Indexes for table `tanker_pp_delivery`
--
ALTER TABLE `tanker_pp_delivery`
  ADD PRIMARY KEY (`tanker_pp_delivery_id`),
  ADD KEY `FKtanker_pp_26918` (`tanker_id`);

--
-- Indexes for table `tanker_register`
--
ALTER TABLE `tanker_register`
  ADD PRIMARY KEY (`tanker_id`),
  ADD KEY `FKtanker_reg899983` (`tanker_type_id`),
  ADD KEY `FKtanker_reg140051` (`plant_id`);

--
-- Indexes for table `tanker_type`
--
ALTER TABLE `tanker_type`
  ADD PRIMARY KEY (`tanker_type_id`);

--
-- Indexes for table `tender_oil`
--
ALTER TABLE `tender_oil`
  ADD PRIMARY KEY (`tender_oil_id`),
  ADD KEY `FKtender_oil712606` (`mtp_oil_id`),
  ADD KEY `FKtender_oil815777` (`supplier_id`),
  ADD KEY `FKtender_oil311071` (`broker_id`);

--
-- Indexes for table `tender_pm`
--
ALTER TABLE `tender_pm`
  ADD PRIMARY KEY (`tender_pm_id`),
  ADD KEY `FKtender_pm350565` (`mtp_pm_id`),
  ADD KEY `FKtender_pm347536` (`broker_id`),
  ADD KEY `FKtender_pm502794` (`supplier_id`);

--
-- Indexes for table `territory_level`
--
ALTER TABLE `territory_level`
...
ALTER TABLE `test_option`
  ADD PRIMARY KEY (`option_id`),
  ADD KEY `FKtest_optio509619` (`test_id`);

--
-- Indexes for table `test_unit`
--
ALTER TABLE `test_unit`
  ADD PRIMARY KEY (`test_unit_id`);
...
ALTER TABLE `user`
  ...
  ADD KEY `FKuser53406` (`designation_id`),
  ADD KEY `FKuser843165` (`plant_id`,`block_id`);
...
--
ALTER TABLE `approval_list`
  MODIFY `approval_id` bigint(19) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=197;
--
-- AUTO_INCREMENT for table `approval_list_history`
--
ALTER TABLE `approval_list_history`
  MODIFY `approval_his_id` bigint(19) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=577;
--
-- AUTO_INCREMENT for table `bank`
--
ALTER TABLE `bank`
  MODIFY `bank_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
--
-- AUTO_INCREMENT for table `bank_guarantee`
--
ALTER TABLE `bank_guarantee`
  MODIFY `bg_id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=163;
--
...
--
-- AUTO_INCREMENT for table `block_designation`
--
ALTER TABLE `block_designation`
  MODIFY `block_designation_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `block_designation_page_history`
--
ALTER TABLE `block_designation_page_history`
  MODIFY `bdph_id` bigint(19) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `broker`
--
ALTER TABLE `broker`
  MODIFY `broker_id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
--
-- AUTO_INCREMENT for table `broker_bank_guarantee`
--
ALTER TABLE `broker_bank_guarantee`
  MODIFY `broker_bg_id` bigint(19) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `capacity`
--
ALTER TABLE `capacity`
  MODIFY `capacity_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `capacity_micron_history`
--
ALTER TABLE `capacity_micron_history`
  MODIFY `cmh_id` bigint(19) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
-- AUTO_INCREMENT for table `counter_sale`
--
ALTER TABLE `counter_sale`
  MODIFY `counter_sale_id` bigint(19) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `coupon`
--
ALTER TABLE `coupon`
  MODIFY `coupon_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `credit_debit_purpose`
--
ALTER TABLE `credit_debit_purpose`
  MODIFY `purpose_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `cron_history`
--
ALTER TABLE `cron_history`
  MODIFY `cron_id` bigint(19) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
--
-- AUTO_INCREMENT for table `cs_category`
--
ALTER TABLE `cs_category`
  MODIFY `cs_category_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `cs_pay_mode`
--
ALTER TABLE `cs_pay_mode`
  MODIFY `cs_pay_mode_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `cs_product`
--
ALTER TABLE `cs_product`
  MODIFY `cs_product_id` bigint(19) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `c_and_f`
--
ALTER TABLE `c_and_f`
  MODIFY `c_and_f_id` bigint(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `c_and_f_agreement_history`
--
ALTER TABLE `c_and_f_agreement_history`
  MODIFY `cfah_id` bigint(19) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `c_and_f_bank_gurantee`
--
ALTER TABLE `c_and_f_bank_gurantee`
  MODIFY `bg_id` bigint(10) NOT NULL AUTO_INCREMENT;
